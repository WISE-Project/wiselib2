...
#				print(oeChild.Name + 40 *'&')
	...
	def GetNSamples_2Body(Lambda: float, oe0, oe1) -> int:
		...
		return rm.ComputeSampling(Lambda, z, L0, L1, Theta0, Theta1, oe1.ComputationSettings.OversamplingFactor)		
...
def FocusSweep(oeFocussing, DefocusList, DetectorSize = 50e-6, AngleInNominal = np.deg2rad(90), NPools = 4):
	...
	HewList : an array of Half Energy Width
	
	SigmaList : an array of Sigma, computed as result of gaussian fitting
