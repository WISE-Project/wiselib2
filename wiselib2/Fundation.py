...
class TreeItem(object):
	...
	def __disp__(self):
		...
		NameParent = ('' if self.Parent is None else self.Parent.Name)
...
#			return self._Items[Name]
	...
	def Insert(self,
		...
		'''
		NewName = (NewName if not(NewName is None) else NewItem.Name )
#		if NewName is None and NewItem.Name is None):
#			print ('ERROR: No Name specified in Tree.Insert method')
#		elif NewName is None and NewItem.Name != None:
#			pass
#		elif NewName != None:
#				NewItem.Name
...
#		TmpDict = {NewName : NewItem}
	...
	def Append(self, NewItem,  posdirective = None, NewName = None):
		...
		print(self._ActiveItem is None)

		if self._ActiveItem is None:
			ExistingItem = None
		else:
	...
	def GetFromTo(self, FromItem,  ToItem = None):
		...
		if FromItem is None and ToItem is None:
